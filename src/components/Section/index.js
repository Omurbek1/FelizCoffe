        ...
        <div>
            <div className="section">
                ...
                <div className="content">
                    ...
                    <p>Вкус кофе зависит от сорта,<br/>качества, условий<br/> выращивания и обработки<br/> кофейных зёрен. В<br/> промышленных масштабах<br/> выращивают 4 вида кофе: <br/> <span className="kinds">арабику, робусту, либерику и<br/> эксцельзу.</span> Самая вкусная и<br/> ароматная, а потому и<br/> наиболее дорогая –<br/><span className="arabic"> арабика.</span></p>
                    </div>
                    <div className="description2">
                    <p>Вкус кофе зависит от сорта,качества, условий выращивания и обработки кофейных зёрен.<br/>  В промышленных масштабах выращивают<br/> 4 вида кофе: <br/> <span className="kinds">арабику, робусту, либерику и эксцельзу.<br/></span> Самая вкусная и ароматная, а потому и<br/> наиболее дорогая –<br/><span className="arabic"> арабика.</span></p>
                    </div>
