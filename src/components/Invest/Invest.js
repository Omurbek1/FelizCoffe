...
import third_right2 from './images/Ellipse 15.png'
import Invest_ban from './images/invest-ban.png'
import invest_ban_left from './images/invest_left.png'
import invest_ban_rigt from './images/three-right2.png'
import investban_center from './images/invest2.png'
import inves_right3 from './images/three-left.png'
    ...
    return (
        <div>
            <div className='first_banner' >
                <img src={banner} alt="" className='invest-banner' />;
            ...
            <div className='second_banner'>
                <img src={second_banner} alt='' className='second_banner_img'/>
            ...
            <div className='four_banner'>
                <div>
                    <img src={Invest_ban} alt='' className='invest_banner' id='invest_banner' />
                    ...
                    <img src={inves_right3} alt='' className='invest-right' />
                ...
                <div>
                    ...
                    <p className='ostatok'><p>1. Островок /3300$</p></p>
